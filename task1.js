...
// ===============================================================================
// написати функцію, яка розвертає стрінгу без методу revers

// const revers = (string) => {
//     let result = string.split('').sort((a, b) => a - b).join('')
//     console.log(result)
// };
// revers('string');
...
// let arr = [4, 1, 16, 0, 4];
// const sumOf = (arr) => {
//    return  arr.reduce((acc, value) => value % 2 === 0 ? acc + Math.sqrt(value): acc, 0)
// }
